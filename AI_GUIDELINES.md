...
- `scripts/database/` — Contains SQL scripts for database setup, triggers, and templates.
...
- Data conventions:
  - All test and production data should be stored in **lowercase**.
  - This includes: names, addresses, document titles, ID type letters (v, e, p), tax IDs, etc.
  - The frontend is responsible for text styling and formatting (capitalization, title case, etc.).
  - CHECK constraints should accept lowercase values.
